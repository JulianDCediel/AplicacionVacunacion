 ...
 * @author User
 */
public class InformePacientes extends javax.swing.JFrame {

    /**
     * Creates new form InformePacientes
     */
    ...
    private void initComponents() {
        ...
        jLabel2.setText("INFORME PACIENTES");
        ...
        tblPacientes.setBackground(new java.awt.Color(204, 204, 204));
        tblPacientes.setFont(new java.awt.Font("Yu Gothic UI", 1, 14)); // NOI18N
        tblPacientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Documento", "Nombre", "Apellidos", "RH", "Regimen", "Tipo Documento", "Correo"
            }
        ));
        tblPacientes.setSelectionForeground(new java.awt.Color(204, 102, 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformePacientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InformePacientes().setVisible(true);
            }
        });
    }
